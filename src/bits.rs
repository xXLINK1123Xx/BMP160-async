...
pub fn raw_reading_to_i16(buf: &[u8], idx: usize) -> i16 {
    let val: i16 = (buf[idx] as i16) << 8 | buf[idx + 1] as i16;
    val
}

pub fn raw_reading_to_u16(buf: &[u8], idx: usize) -> u16 {
    let val: u16 = (buf[idx] as u16) << 8 | buf[idx + 1] as u16;
    val
}

pub fn raw_reading_to_i32(buf: &[u8], idx: usize) -> i32 {
    let val: i32 = (buf[idx] as i32) << 16 | (buf[idx + 1] as i32) << 8 | buf[idx + 2] as i32;
    val
}
